...
namespace Back_end.Infrastructure.Migrations
{
    ...
    [Migration("20260103000721_AddBrandLogos")]
    partial class AddBrandLogos
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Back_end.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 3, 0, 7, 21, 431, DateTimeKind.Utc).AddTicks(7600),
                            Email = "admin@carhouse.com",
                            FirstName = "Admin",
                            LastName = "User",
                            PasswordHash = "$2a$11$TqGoKMP1yQZloXSoKlRbZ.RAww.n8Ut7qXSCRd9RbHTMTqgCBXEry",
