...
namespace Back_end.Infrastructure.Migrations
{
    ...
    [Migration("20260103170747_AddCarImages")]
            ...
            modelBuilder.Entity("Back_end.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 3, 17, 7, 47, 757, DateTimeKind.Utc).AddTicks(1340),
                            Email = "admin@carhouse.com",
                            FirstName = "Admin",
                            LastName = "User",
                            PasswordHash = "$2a$11$U2MvnDiGQIRCWNAN1gUT/OY3MwL.EfSV8wX6/frHGTQ51uZX8nA9O",
