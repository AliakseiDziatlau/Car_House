...
namespace Back_end.Infrastructure.Migrations
{
    ...
    [Migration("20260103171820_FixBrandLogos")]
    partial class FixBrandLogos
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Back_end.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 3, 17, 18, 20, 573, DateTimeKind.Utc).AddTicks(7030),
                            Email = "admin@carhouse.com",
                            FirstName = "Admin",
                            LastName = "User",
                            PasswordHash = "$2a$11$6UxrO.QQgz62N42BbwWV.uzZSV5/ysdS1WSp8eaXXcUG0PhbyaBXW",
